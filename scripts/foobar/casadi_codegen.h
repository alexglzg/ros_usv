...
int sampler_psi(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem);
int sampler_psi_alloc_mem(void);
int sampler_psi_init_mem(int mem);
void sampler_psi_free_mem(int mem);
int sampler_psi_checkout(void);
void sampler_psi_release(int mem);
void sampler_psi_incref(void);
void sampler_psi_decref(void);
casadi_int sampler_psi_n_out(void);
casadi_int sampler_psi_n_in(void);
casadi_real sampler_psi_default_in(casadi_int i);
const char* sampler_psi_name_in(casadi_int i);
const char* sampler_psi_name_out(casadi_int i);
const casadi_int* sampler_psi_sparsity_in(casadi_int i);
const casadi_int* sampler_psi_sparsity_out(casadi_int i);
int sampler_psi_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w);
