...
# Lagrange objective
ocp.add_objective(ocp.sum(Qye*(ye**2) + Qp*(sin(chi)-sin(gamma_p))**2 + Qp*(cos(chi)-cos(gamma_p))**2 + QNr*(r**2) + R*(Ur**2)))
...
ax2.plot(yd_history, xd_history, 'r-')
ax2.plot(y_history, x_history, 'b--')
ax2.set_xlabel('Y [m]')
ax2.set_ylabel('X [m]')

ax3.plot(time_sim, s_history, 'b-')
ax3.set_xlabel('Time [s]')
ax3.set_ylabel('s')

ax4.plot(time_sim, psi_history, 'b-')
ax4.set_xlabel('Time [s]')
ax4.set_ylabel('psi [rad]')

plt.save_fig('out2.png')